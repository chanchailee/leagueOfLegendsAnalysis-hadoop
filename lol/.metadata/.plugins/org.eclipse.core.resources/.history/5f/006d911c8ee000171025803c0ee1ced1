 ...
 * 
 * Does number of wards in each game correspond to winning percentage for winner team?
 * 
 * Output:
 * 		key: "ward_matters"
...
public class MapData {
	...
	public static class MDMapper extends Mapper<LongWritable, Text, Text, Text> {
