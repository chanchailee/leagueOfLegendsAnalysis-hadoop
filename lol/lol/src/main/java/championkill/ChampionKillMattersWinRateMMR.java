 ...
 * Does number of champion kill correspond to team_win_rate for low MMR and high MMR?
 * 
 * This class will use input from ChampionKillMapData.java output.
 * */


public class ChampionKillMattersWinRateMMR {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = new Job(c, "Find winner_team winrate that correspond to number of champion killed or not "
				+ "for both low and high MMR");
		/* Specific main class in side jar file */
		job1.setJarByClass(ChampionKillMattersWinRateMMR.class);
		/* Specific name for mapper class */
		job1.setMapperClass(CKMWRMMRMapper.class);
		/* Specific name for reducer class */
		job1.setReducerClass(CKMWRMMRReducer.class);
	...
	public static class CKMWRMMRMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
	...
	public static class CKMWRMMRReducer extends Reducer<Text, Text, Text,Text> {
