...
/*
 * Purpose: Find ward position from total games for Low MMR player (MMR <2000)  and won the match
 * 
 * This class uses input from MapWard.java's output
 * 
 * input format:  game_id, mmr , match_result, x, y,interval
 * */
public class LowMMRWonWard {
	public static void main(String[] args) throws Exception {
		...
		Job job1 = new Job(c, "Find Low MMR Won Ward");
		/* Specific main class in side jar file */
		job1.setJarByClass(LowMMRWonWard.class);
		/* Specific name for mapper class */
		job1.setMapperClass(LMMRWMapper.class);
		/* Specific name for reducer class */
		job1.setReducerClass(LMMRWReducer.class);
	...
	public static class LMMRWMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
		String result = null;
	...
	public static class LMMRWReducer extends Reducer<Text, Text, Text, Text> {
