...
/*
 * Purpose: Find ward position from total games for Late game interval 
 * 
...
public class LateGameWard {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = new Job(c, "Find Late Game Ward");
		/* Specific main class in side jar file */
		job1.setJarByClass(LateGameWard.class);
		/* Specific name for mapper class */
		job1.setMapperClass(LGWMapper.class);
		/* Specific name for reducer class */
		job1.setReducerClass(LGWReducer.class);
	...
	public static class LGWMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
	...
	public static class LGWReducer extends Reducer<Text, Text, Text, Text> {
