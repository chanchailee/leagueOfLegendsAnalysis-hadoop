...
public class LowMMRWard {
	...
	public static class LMMRMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
	...
	public static class LMMRReducer extends Reducer<Text, Text, Text, Text> {
