 ...
 * Does number of minion kill correspond to team_win_rate for all MMR?
 * 
 * This class will use input from MinionMapData.java output.
 * */

public class MinionMattersWinRate {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = new Job(c, "Find winner_team winrate that correspond to number of minion killed or not");
		/* Specific main class in side jar file */
		job1.setJarByClass(MinionMattersWinRate.class);
	...
	public static class MMWRMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
	...
	public static class MMWRReducer extends Reducer<Text, Text, Text,Text> {
