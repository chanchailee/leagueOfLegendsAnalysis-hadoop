...
public class WardMattersWinRateMMR {
	...
	public static void main(String[] args) throws Exception {
		...
		Job job1 = new Job(c,
				"Find winner_team winrate that correspond to number of ward or not for both low MMR and high MMR");
		/* Specific main class in side jar file */
		job1.setJarByClass(WardMattersWinRateMMR.class);
		/* Specific name for mapper class */
		job1.setMapperClass(MMRMapper.class);
		/* Specific name for reducer class */
		job1.setReducerClass(MMRReducer.class);
	...
	public static class MMRMapper extends Mapper<LongWritable, Text, Text, Text> {
		Text k2 = new Text();
		Text v2 = new Text();
		...
		public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {
			...
			for (String line : lines) {
				...
				/*
				 * items[0] = ward_matters, items[1] = 1 or 0 , items[2] = mmr
				 * (low or high)
				 * 
				 */
	...
	public static class MMRReducer extends Reducer<Text, Text, Text, Text> {
